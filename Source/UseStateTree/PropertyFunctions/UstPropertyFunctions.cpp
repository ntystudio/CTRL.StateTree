...
#include UE_INLINE_GENERATED_CPP_BY_NAME(UstPropertyFunctions)

#define LOCTEXT_NAMESPACE "UseStateTree"

//~ ━━━━━━━━━━━━━━━━━━━━━━━━ FUstRandomFloatPropertyFunction ━━━━━━━━━━━━━━━━━━━━━━━━━ //

void FUstRandomFloatPropertyFunction::Execute(FStateTreeExecutionContext& Context) const
{
...
#if WITH_EDITOR
FText FUstRandomFloatPropertyFunction::GetDescription(
	FGuid const& ID,
...
//~ ━━━━━━━━━━━━━━━━━━━━━━━━━ FUstRandomIntPropertyFunction ━━━━━━━━━━━━━━━━━━━━━━━━━━ //

void FUstRandomIntPropertyFunction::Execute(FStateTreeExecutionContext& Context) const
{
	auto& [Left, Right, Result] = Context.GetInstanceData(*this);
	Result = FMath::RandRange(Left, Right);
}
...
#if WITH_EDITOR
FText FUstRandomIntPropertyFunction::GetDescription(
	FGuid const& ID,
	FStateTreeDataView const InstanceDataView,
	IStateTreeBindingLookup const& BindingLookup,
	EStateTreeNodeFormatting const Formatting
...
//~ ━━━━━━━━━━━━━━━━━━━━━━━━ FUstStringToTextPropertyFunction ━━━━━━━━━━━━━━━━━━━━━━━━ //

void FUstStringToTextPropertyFunction::Execute(FStateTreeExecutionContext& Context) const
{
...
#if WITH_EDITOR
FText FUstStringToTextPropertyFunction::GetDescription(
	FGuid const& ID,
	FStateTreeDataView const InstanceDataView,
	IStateTreeBindingLookup const& BindingLookup,
	EStateTreeNodeFormatting const Formatting
...
void FUstStringToNamePropertyFunction::Execute(FStateTreeExecutionContext& Context) const
{
	auto& [Input, Result] = Context.GetInstanceData(*this);
	Result = FName(Input);
}

FText FUstStringToNamePropertyFunction::GetDescription(FGuid const& ID, FStateTreeDataView InstanceDataView, IStateTreeBindingLookup const& BindingLookup, EStateTreeNodeFormatting Formatting) const
{
	auto const& [Input, Result] = InstanceDataView.Get<FInstanceDataType>();
...
//~ ━━━━━━━━━━━━━━━━━━━━━━━━ FUstBoolToStringPropertyFunction ━━━━━━━━━━━━━━━━━━━━━━━━ //

void FUstBoolToStringPropertyFunction::Execute(FStateTreeExecutionContext& Context) const
{
	auto& [Input, Result] = Context.GetInstanceData(*this);
...
#if WITH_EDITOR
FText FUstBoolToStringPropertyFunction::GetDescription(
	FGuid const& ID,
	FStateTreeDataView const InstanceDataView,
	IStateTreeBindingLookup const& BindingLookup,
	EStateTreeNodeFormatting const Formatting
...
//~ ━━━━━━━━━━━━━━━━━━━━━━━ FUstObjectIsValidPropertyFunction ━━━━━━━━━━━━━━━━━━━━━━━━ //

void FUstObjectIsValidPropertyFunction::Execute(FStateTreeExecutionContext& Context) const
{
...
#if WITH_EDITOR
FText FUstObjectIsValidPropertyFunction::GetDescription(
	FGuid const& ID,
	FStateTreeDataView const InstanceDataView,
	IStateTreeBindingLookup const& BindingLookup,
	EStateTreeNodeFormatting const Formatting
